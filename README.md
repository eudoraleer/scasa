...
The annotation can be downloaded here: [__Annotation data for running scasa (alevin mapper) using refseq hg38 with chM__](https://www.dropbox.com/s/lq6xs6d41o1ujxd/scasa_refseq_hg38_chrM.zip). The version for Homo_sapiens.GRCh38.106 of ENSEMBL can be found in [folder Anno](https://github.com/eudoraleer/scasa/tree/main/Anno).
Users can use the annotation files and replace the default reference data in scasa to get results with chM, please see on [folder Anno](https://github.com/eudoraleer/scasa/tree/main/Anno).
